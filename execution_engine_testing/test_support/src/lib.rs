//! A library to support testing of Wasm smart contracts for use on the Dimension Platform.

#![doc(html_root_url = "https://docs.rs/dimension-engine-test-support/2.0.3")]
#![doc(
...
use dimension_types::{account::AccountHash, Motes, ProtocolVersion, PublicKey, SecretKey, U512};
...
/// Default chain name.
pub const DEFAULT_CHAIN_NAME: &str = "dimension-execution-engine-testing";
