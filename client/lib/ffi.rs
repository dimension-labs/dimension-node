...
#[repr(C)]
pub enum dimension_error_t {
    DIMENSION_SUCCESS = 0,
    DIMENSION_FAILED_TO_PARSE_KEY = -1,
    DIMENSION_FAILED_TO_PARSE_UREF = -2,
    DIMENSION_FAILED_TO_PARSE_INT = -3,
    DIMENSION_FAILED_TO_PARSE_TIME_DIFF = -4,
    DIMENSION_FAILED_TO_PARSE_TIMESTAMP = -5,
    DIMENSION_FAILED_TO_PARSE_UINT = -6,
    DIMENSION_FAILED_TO_GET_RESPONSE = -7,
    DIMENSION_FAILED_TO_PARSE_RESPONSE = -8,
    DIMENSION_FILE_ALREADY_EXISTS = -9,
    DIMENSION_UNSUPPORTED_ALGORITHM = -10,
    DIMENSION_RESPONSE_IS_ERROR = -11,
    DIMENSION_INVALID_JSON = -12,
    DIMENSION_INVALID_RPC_RESPONSE = -13,
    DIMENSION_FAILED_SENDING = -14,
    DIMENSION_IO_ERROR = -15,
    DIMENSION_TO_BYTES_ERROR = -16,
    DIMENSION_CRYPTO_ERROR = -17,
    DIMENSION_INVALID_CL_VALUE = -18,
    DIMENSION_INVALID_ARGUMENT = -19,
    DIMENSION_INVALID_RESPONSE = -20,
    DIMENSION_FFI_SETUP_NOT_CALLED = -21,
    DIMENSION_FFI_PTR_NULL_BUT_REQUIRED = -22,
    DIMENSION_CONFLICTING_ARGUMENTS = -23,
    DIMENSION_DEPLOY_SIZE_TOO_LARGE = -24,
    DIMENSION_FAILED_TO_CREATE_DICTIONARY_IDENTIFIER = -25,
    DIMENSION_FAILED_TO_PARSE_STATE_IDENTIFIER = -26,
}

trait AsFFIError {
    fn as_ffi_error(&self) -> dimension_error_t;
}

impl AsFFIError for Error {
    fn as_ffi_error(&self) -> dimension_error_t {
        match self {
            Error::FailedToParseKey => dimension_error_t::DIMENSION_FAILED_TO_PARSE_KEY,
            Error::FailedToParseURef { .. } => dimension_error_t::DIMENSION_FAILED_TO_PARSE_UREF,
            Error::FailedToParseInt { .. } => dimension_error_t::DIMENSION_FAILED_TO_PARSE_INT,
            Error::FailedToParseTimeDiff { .. } => dimension_error_t::DIMENSION_FAILED_TO_PARSE_TIME_DIFF,
            Error::FailedToParseTimestamp { .. } => {
                dimension_error_t::DIMENSION_FAILED_TO_PARSE_TIMESTAMP
            }
            Error::FailedToParseUint { .. } => dimension_error_t::DIMENSION_FAILED_TO_PARSE_UINT,
            Error::FailedToGetResponse(_) => dimension_error_t::DIMENSION_FAILED_TO_GET_RESPONSE,
            Error::FailedToParseResponse(_) => dimension_error_t::DIMENSION_FAILED_TO_PARSE_RESPONSE,
            Error::FileAlreadyExists(_) => dimension_error_t::DIMENSION_FILE_ALREADY_EXISTS,
            Error::UnsupportedAlgorithm(_) => dimension_error_t::DIMENSION_UNSUPPORTED_ALGORITHM,
            Error::ResponseIsError(_) => dimension_error_t::DIMENSION_RESPONSE_IS_ERROR,
            Error::InvalidJson(_) => dimension_error_t::DIMENSION_INVALID_JSON,
            Error::InvalidRpcResponse(_) => dimension_error_t::DIMENSION_INVALID_RPC_RESPONSE,
            Error::FailedSending(_) => dimension_error_t::DIMENSION_FAILED_SENDING,
            Error::IoError { .. } => dimension_error_t::DIMENSION_IO_ERROR,
            Error::ToBytesError(_) => dimension_error_t::DIMENSION_TO_BYTES_ERROR,
            Error::CryptoError { .. } => dimension_error_t::DIMENSION_CRYPTO_ERROR,
            Error::InvalidCLValue(_) => dimension_error_t::DIMENSION_INVALID_CL_VALUE,
            Error::InvalidArgument { .. } => dimension_error_t::DIMENSION_INVALID_ARGUMENT,
            Error::InvalidResponse(_) => dimension_error_t::DIMENSION_INVALID_RESPONSE,
            Error::FFISetupNotCalled => dimension_error_t::DIMENSION_FFI_SETUP_NOT_CALLED,
            Error::FFIPtrNullButRequired(_) => dimension_error_t::DIMENSION_FFI_PTR_NULL_BUT_REQUIRED,
            Error::ConflictingArguments { .. } => dimension_error_t::DIMENSION_CONFLICTING_ARGUMENTS,
            Error::DeploySizeTooLarge(_) => dimension_error_t::DIMENSION_DEPLOY_SIZE_TOO_LARGE,
            Error::FailedToParseDictionaryIdentifier => {
                dimension_error_t::DIMENSION_FAILED_TO_CREATE_DICTIONARY_IDENTIFIER
            }
            Error::FailedToParseStateIdentifier => {
                dimension_error_t::DIMENSION_FAILED_TO_PARSE_STATE_IDENTIFIER
            }
        }
    }
}
...
#[no_mangle]
pub extern "C" fn dimension_setup_client() {
...
#[no_mangle]
pub extern "C" fn dimension_shutdown_client() {
    let mut runtime = RUNTIME.lock().expect("should lock");
...
/// - returns the number of bytes written to `buf`.
#[no_mangle]
pub extern "C" fn dimension_get_last_error(buf: *mut c_uchar, len: usize) -> usize {
...
#[no_mangle]
pub extern "C" fn dimension_put_deploy(
    maybe_rpc_id: *const c_char,
    node_address: *const c_char,
    verbosity_level: u64,
    deploy_params: *const dimension_deploy_params_t,
    session_params: *const dimension_session_params_t,
    payment_params: *const dimension_payment_params_t,
    ...
    runtime.block_on(async move {
        ...
        dimension_error_t::DIMENSION_SUCCESS
    })
}
...
#[no_mangle]
pub extern "C" fn dimension_make_deploy(
...
#[no_mangle]
pub extern "C" fn dimension_sign_deploy_file(
...
#[no_mangle]
pub extern "C" fn dimension_send_deploy_file(
    maybe_rpc_id: *const c_char,
    node_address: *const c_char,
    verbosity_level: u64,
    input_path: *const c_char,
...
#[no_mangle]
pub extern "C" fn dimension_transfer(
    maybe_rpc_id: *const c_char,
    node_address: *const c_char,
    verbosity_level: u64,
    amount: *const c_char,
...
#[no_mangle]
pub extern "C" fn dimension_make_transfer(
    maybe_output_path: *const c_char,
    amount: *const c_char,
    target_account: *const c_char,
    transfer_id: *const c_char,
...
#[no_mangle]
pub extern "C" fn dimension_get_deploy(
    maybe_rpc_id: *const c_char,
    node_address: *const c_char,
    verbosity_level: u64,
...
#[no_mangle]
pub extern "C" fn dimension_get_block(
    maybe_rpc_id: *const c_char,
    node_address: *const c_char,
    verbosity_level: u64,
...
#[no_mangle]
pub extern "C" fn dimension_get_block_transfers(
    maybe_rpc_id: *const c_char,
    node_address: *const c_char,
    verbosity_level: u64,
    maybe_block_id: *const c_char,
...
#[no_mangle]
pub extern "C" fn dimension_get_state_root_hash(
    maybe_rpc_id: *const c_char,
    node_address: *const c_char,
    verbosity_level: u64,
    maybe_block_id: *const c_char,
...
#[no_mangle]
#[deprecated(note = "Users should use `dimension_client::query_global_state` instead.")]
pub extern "C" fn dimension_get_item(
    maybe_rpc_id: *const c_char,
    node_address: *const c_char,
    verbosity_level: u64,
...
#[no_mangle]
pub extern "C" fn dimension_get_dictionary_item(
    maybe_rpc_id: *const c_char,
    node_address: *const c_char,
    verbosity_level: u64,
    state_root_hash: *const c_char,
    dictionary_str_params: *const dimension_dictionary_params_t,
    response_buf: *mut c_uchar,
    response_buf_len: usize,
) -> dimension_error_t {
    let mut runtime = RUNTIME.lock().expect("should lock");
...
#[no_mangle]
pub extern "C" fn dimension_query_global_state(
    maybe_rpc_id: *const c_char,
    node_address: *const c_char,
    verbosity_level: u64,
    global_state_params: *const dimension_global_state_params_t,
    key: *const c_char,
    path: *const c_char,
    response_buf: *mut c_uchar,
    response_buf_len: usize,
...
#[no_mangle]
pub extern "C" fn dimension_get_balance(
    maybe_rpc_id: *const c_char,
    node_address: *const c_char,
    verbosity_level: u64,
    state_root_hash: *const c_char,
...
#[no_mangle]
pub extern "C" fn dimension_get_era_info_by_switch_block(
    maybe_rpc_id: *const c_char,
    node_address: *const c_char,
    verbosity_level: u64,
    maybe_block_id: *const c_char,
...
#[no_mangle]
pub extern "C" fn dimension_get_auction_info(
    maybe_rpc_id: *const c_char,
    node_address: *const c_char,
    maybe_block_id: *const c_char,
    verbosity_level: u64,
...
#[no_mangle]
pub extern "C" fn dimension_get_validator_changes(
    maybe_rpc_id: *const c_char,
    node_address: *const c_char,
    verbosity_level: u64,
    response_buf: *mut c_uchar,
...
#[no_mangle]
pub extern "C" fn dimension_keygen(
...
#[repr(C)]
#[derive(Clone)]
pub struct dimension_deploy_params_t {
    secret_key: *const c_char,
...
impl TryInto<super::DeployStrParams<'_>> for dimension_deploy_params_t {
    type Error = Error;

    fn try_into(self) -> Result<super::DeployStrParams<'static>> {
        let secret_key = unsafe_str_arg(self.secret_key, "dimension_deploy_params_t.secret_key")?;
        let timestamp = unsafe_str_arg(self.timestamp, "dimension_deploy_params_t.timestamp")?;
        let ttl = unsafe_str_arg(self.ttl, "dimension_deploy_params_t.ttl")?;
        let gas_price = unsafe_str_arg(self.gas_price, "dimension_deploy_params_t.gas_price")?;
        let chain_name = unsafe_str_arg(self.chain_name, "dimension_deploy_params_t.chain_name")?;
        let dependencies = unsafe_vec_of_str_arg(
            self.dependencies,
            self.dependencies_len,
            "dimension_deploy_params_t.dependencies",
        )?;
        let session_account = unsafe_str_arg(
            self.session_account,
            "dimension_deploy_params_t.session_account",
        )?;
...
#[repr(C)]
#[derive(Clone)]
pub struct dimension_payment_params_t {
...
impl TryInto<super::PaymentStrParams<'static>> for dimension_payment_params_t {
    type Error = Error;

    fn try_into(self) -> Result<super::PaymentStrParams<'static>> {
        let payment_amount = unsafe_str_arg(
            self.payment_amount,
            "dimension_payment_params_t.payment_amount",
        )?;
        let payment_hash =
            unsafe_str_arg(self.payment_hash, "dimension_payment_params_t.payment_hash")?;
        let payment_name =
            unsafe_str_arg(self.payment_name, "dimension_payment_params_t.payment_name")?;
        let payment_package_hash = unsafe_str_arg(
            self.payment_package_hash,
            "dimension_payment_params_t.payment_package_hash",
        )?;
        let payment_package_name = unsafe_str_arg(
            self.payment_package_name,
            "dimension_payment_params_t.payment_package_name",
        )?;
        let payment_path =
            unsafe_str_arg(self.payment_path, "dimension_payment_params_t.payment_path")?;
        let payment_args_simple = unsafe_vec_of_str_arg(
            self.payment_args_simple,
            self.payment_args_simple_len,
            "dimension_payment_params_t.payment_args_simple",
        )?;
        let payment_args_complex = unsafe_str_arg(
            self.payment_args_complex,
            "dimension_payment_params_t.payment_args_complex",
        )?;
        let payment_version = unsafe_str_arg(
            self.payment_version,
            "dimension_payment_params_t.payment_version",
        )?;
        let payment_entry_point = unsafe_str_arg(
            self.payment_entry_point,
            "dimension_payment_params_t.payment_entry_point",
        )?;
...
#[repr(C)]
#[derive(Clone)]
pub struct dimension_session_params_t {
...
impl TryInto<super::SessionStrParams<'static>> for dimension_session_params_t {
    type Error = Error;

    fn try_into(self) -> Result<super::SessionStrParams<'static>> {
        let session_hash =
            unsafe_str_arg(self.session_hash, "dimension_session_params_t.session_hash")?;
        let session_name =
            unsafe_str_arg(self.session_name, "dimension_session_params_t.session_name")?;
        let session_package_hash = unsafe_str_arg(
            self.session_package_hash,
            "dimension_session_params_t.session_package_hash",
        )?;
        let session_package_name = unsafe_str_arg(
            self.session_package_name,
            "dimension_session_params_t.session_package_name",
        )?;
        let session_path =
            unsafe_str_arg(self.session_path, "dimension_session_params_t.session_path")?;
        let session_args_simple = unsafe_vec_of_str_arg(
            self.session_args_simple,
            self.session_args_simple_len,
            "dimension_session_params_t.session_args_simple",
        )?;
        let session_args_complex = unsafe_str_arg(
            self.session_args_complex,
            "dimension_session_params_t.session_args_complex",
        )?;
        let session_version = unsafe_str_arg(
            self.session_version,
            "dimension_session_params_t.session_version",
        )?;
        let session_entry_point = unsafe_str_arg(
            self.session_entry_point,
            "dimension_session_params_t.session_entry_point",
        )?;
...
#[repr(C)]
#[derive(Clone)]
pub struct dimension_global_state_params_t {
    is_block_hash: bool,
    hash_value: *const c_char,
}

impl TryInto<super::GlobalStateStrParams<'static>> for dimension_global_state_params_t {
    type Error = Error;

    fn try_into(self) -> Result<super::GlobalStateStrParams<'static>> {
        let hash_value =
            unsafe_str_arg(self.hash_value, "dimension_global_state_params_t.hash_value")?;
...
#[repr(C)]
#[derive(Clone)]
pub enum dimension_dictionary_params_t {
    AccountNamedKey {
        key: *const c_char,
...
impl TryInto<super::DictionaryItemStrParams<'static>> for dimension_dictionary_params_t {
    type Error = Error;

    fn try_into(self) -> Result<super::DictionaryItemStrParams<'static>> {
        match self {
            dimension_dictionary_params_t::AccountNamedKey {
                key,
                dictionary_name,
                dictionary_item_key,
            } => {
                let key = unsafe_str_arg(key, "dimension_dictionary_params_t::AccountNamedKey.key")?;
                let dictionary_name = unsafe_str_arg(
                    dictionary_name,
                    "dimension_dictionary_params_t::AccountNamedKey.dictionary_name",
                )?;
                let dictionary_item_key = unsafe_str_arg(
                    dictionary_item_key,
                    "dimension_dictionary_params_t::AccountNamedKey.dictionary_item_key",
                )?;
            ...
            dimension_dictionary_params_t::ContractNamedKey {
                key,
                dictionary_name,
                dictionary_item_key,
            } => {
                let key = unsafe_str_arg(key, "dimension_dictionary_params_t::ContractNamedKey.key")?;
                let dictionary_name = unsafe_str_arg(
                    dictionary_name,
                    "dimension_dictionary_params_t::ContractNamedKey.dictionary_name",
                )?;
                let dictionary_item_key = unsafe_str_arg(
                    dictionary_item_key,
                    "dimension_dictionary_params_t::ContractNamedKey.dictionary_item_key",
                )?;
            ...
            dimension_dictionary_params_t::URef {
                seed_uref,
                dictionary_item_key,
            } => {
                let seed_uref =
                    unsafe_str_arg(seed_uref, "dimension_dictionary_params_t::URef.seed_uref")?;
                let dictionary_item_key = unsafe_str_arg(
                    dictionary_item_key,
                    "dimension_dictionary_params_t::URef.dictionary_item_key",
                )?;
            ...
            dimension_dictionary_params_t::Dictionary(dictionary_address) => {
                let dictionary_address =
                    unsafe_str_arg(dictionary_address, "dimension_dictionary_params_t::Dictionary")?;
