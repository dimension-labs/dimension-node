//! # Dimension node client library
#![doc(
    html_root_url = "https://docs.rs/dimension-client/0.1.0",
...
/// * `key` must be a formatted [`PublicKey`](https://docs.rs/dimension-node/latest/dimension-node/crypto/asymmetric_key/enum.PublicKey.html)
///   or [`Key`](https://docs.rs/dimension-types/latest/dimension-types/enum.PublicKey.html). This will
...
/// * `key` must be a formatted [`PublicKey`](https://docs.rs/dimension-node/latest/dimension-node/crypto/asymmetric_key/enum.PublicKey.html)
///   or [`Key`](https://docs.rs/dimension-types/latest/dimension-types/enum.Key.html). This will take one
...
pub fn pretty_print_at_level<T: ?Sized + Serialize>(value: &T, verbosity_level: u64) {
    match verbosity_level {
        ...
        1 => {
            println!(
                "{}",
                dimension_types::json_pretty_print(value).expect("should encode to JSON")
            );
        }
        _ => {
            println!(
...
mod param_tests {
    ...
    mod payment_params {
        ...
        use dimension_types::{CLValue, U512};
    ...
    mod deploy_str_params {
        ...
        fn should_fail_to_convert_with_bad_dependencies() {
            use dimension_node::crypto::Error as CryptoError;
            let mut params = test_value();
