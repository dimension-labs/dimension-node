...
use dimension_client::{DictionaryItemStrParams, Error};
use dimension_node::rpcs::state::GetDictionaryItem;
use dimension_types::PublicKey;
...
mod key {
    use dimension_node::crypto::AsymmetricKeyExt;
    use dimension_types::AsymmetricType;
