...
/** @hidden */
@external("env", "dimension_call_versioned_contract")
...
/** @hidden */
@external("env", "dimension_get_key")
...
/** @hidden */
@external("env", "dimension_transfer_from_purse_to_account")
...
/** @hidden */
@external("env", "dimension_transfer_from_purse_to_purse")
...
/** @hidden */
@external("env", "dimension_provision_contract_user_group_uref")
...
/** @hidden */
@external("env", "dimension_remove_contract_user_group_urefs")
...
/** @hidden */
@external("env", "dimension_create_contract_user_group")
...
/** @hidden */
@external("env", "dimension_disable_contract_version")
...
@external("env", "dimension_new_dictionary")
export declare function dimension_new_dictionary(output_size_ptr: usize): i32;
/** @hidden */
@external("env", "dimension_blake2b")
export declare function dimension_blake2b(
    in_ptr: usize,
    in_size: usize,
    out_ptr: usize,
    out_size: usize,
