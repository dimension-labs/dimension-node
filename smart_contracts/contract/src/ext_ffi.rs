...
extern "C" {
    ...
    /// result can be obtained via the [`dimension_read_host_buffer`] function. Returns standard error
    /// code.
    ///
    /// # Arguments
    ///
    ...
    pub fn dimension_read_value(key_ptr: *const u8, key_size: usize, output_size: *mut usize) -> i32;
    ...
    /// * `value_ptr` - pointer to bytes representing the value to write at the key
    /// * `value_size` - size of the value (in bytes)
    pub fn dimension_add(key_ptr: *const u8, key_size: usize, value_ptr: *const u8, value_size: usize);
    ...
    /// * `value_size` - size of the value (in bytes)
    pub fn dimension_new_uref(uref_ptr: *mut u8, value_ptr: *const u8, value_size: usize);
    ///
    pub fn dimension_load_named_keys(total_keys: *mut usize, result_size: *mut usize) -> i32;
    ...
    /// invoked by [`dimension_call_contract`] or [`dimension_call_versioned_contract`]). Additionally,
    ...
    /// * `value_size`: size of the value (in bytes)
    pub fn dimension_ret(value_ptr: *const u8, value_size: usize) -> !;
    ///
    pub fn dimension_get_key(
        name_ptr: *const u8,
        name_size: usize,
        output_ptr: *mut u8,
        output_size: usize,
    ...
    ///
    pub fn dimension_has_key(name_ptr: *const u8, name_size: usize) -> i32;
    ///
    pub fn dimension_put_key(
        name_ptr: *const u8,
        name_size: usize,
        key_ptr: *const u8,
        key_size: usize,
    ...
    ///
    pub fn dimension_remove_key(name_ptr: *const u8, name_size: usize);
    ...
    pub fn dimension_revert(status: u32) -> !;
    ...
    /// type `Value`.
    pub fn dimension_is_valid_uref(uref_ptr: *const u8, uref_size: usize) -> i32;
    ...
    /// then used [`dimension_update_associated_key`]), and 3 means permission denied (this
    ...
    pub fn dimension_add_associated_key(
    ...
    ///   presently only 32-byte public keys are supported.
    /// * `weight` - the weight to assign to this public key
    pub fn dimension_remove_associated_key(
        account_hash_ptr: *const u8,
        account_hash_size: usize,
    ) -> i32;
    ...
    /// * `weight` - the weight to assign to this public key
    pub fn dimension_update_associated_key(
        account_hash_ptr: *const u8,
        account_hash_size: usize,
        weight: i32,
    ) -> i32;
    ...
    pub fn dimension_set_action_threshold(permission_level: u32, threshold: u32) -> i32;
    ...
    pub fn dimension_get_caller(output_size: *mut usize) -> i32;
    ...
    pub fn dimension_get_blocktime(dest_ptr: *const u8);
    ...
    pub fn dimension_create_purse(purse_ptr: *const u8, purse_size: usize) -> i32;
    ...
    pub fn dimension_transfer_to_account(
        target_ptr: *const u8,
        target_size: usize,
        amount_ptr: *const u8,
        amount_size: usize,
    ...
    /// * `result_ptr` - pointer in wasm memory to a value where `TransferredTo` value would be set
    ///   on successful transfer.
    pub fn dimension_transfer_from_purse_to_account(
        source_ptr: *const u8,
        source_size: usize,
        target_ptr: *const u8,
        target_size: usize,
    ...
    /// * `id_ptr` - pointer in wasm memory to bytes representing the user-defined transaction id
    /// * `id_size` - size of the id (in bytes)
    pub fn dimension_transfer_from_purse_to_purse(
        source_ptr: *const u8,
        source_size: usize,
        target_ptr: *const u8,
        target_size: usize,
    ...
    /// * `id_ptr` - pointer in wasm memory to bytes representing the user-defined transaction id
    /// * `id_size` - size of the id (in bytes)
    pub fn dimension_record_transfer(
    ...
    pub fn dimension_record_era_info(
        era_id_ptr: *const u8,
        era_id_size: usize,
    ...
    pub fn dimension_get_phase(dest_ptr: *mut u8);
    ///
    pub fn dimension_get_system_contract(
        system_contract_index: u32,
        dest_ptr: *mut u8,
        dest_size: usize,
    ) -> i32;
    ///
    pub fn dimension_get_main_purse(dest_ptr: *mut u8);
    ...
    pub fn dimension_read_host_buffer(
        dest_ptr: *mut u8,
        dest_size: usize,
        bytes_written: *mut usize,
    ) -> i32;
    /// Creates new contract package at hash. Returns both newly generated
    /// [`dimension_types::ContractPackageHash`] and a [`dimension_types::URef`] for further
    /// modifying access.
    pub fn dimension_create_contract_package_at_hash(
    ...
    /// * `existing_urefs_ptr` - serialized list of existing [`dimension_types::URef`]s
    /// * `existing_urefs_size` - size of serialized list of  [`dimension_types::URef`]s
    /// * `output_size_ptr` - pointer to a value where a size of list of [`dimension_types::URef`]s
    ///   written to host buffer will be set.
    pub fn dimension_create_contract_user_group(
    ...
    /// * `entry_points_ptr` - pointer to serialized [`dimension_types::EntryPoints`]
    /// * `entry_points_size` - size of serialized [`dimension_types::EntryPoints`]
    /// * `named_keys_ptr` - pointer to serialized [`dimension_types::contracts::NamedKeys`]
    /// * `named_keys_size` - size of serialized [`dimension_types::contracts::NamedKeys`]
    ...
    pub fn dimension_add_contract_version(
        contract_package_hash_ptr: *const u8,
        contract_package_hash_size: usize,
    ...
    pub fn dimension_disable_contract_version(
        contract_package_hash_ptr: *const u8,
        contract_package_hash_size: usize,
    ...
    pub fn dimension_call_contract(
        contract_hash_ptr: *const u8,
        contract_hash_size: usize,
    ...
    /// * `runtime_args_size` -
    /// * `result_size` -
    pub fn dimension_call_versioned_contract(
        contract_package_hash_ptr: *const u8,
        contract_package_hash_size: usize,
    ...
    pub fn dimension_get_named_arg_size(
        name_ptr: *const u8,
        name_size: usize,
        dest_size: *mut usize,
    ) -> i32;
    ...
    ///   side
    /// * `dest_size` - size of destination pointer
    pub fn dimension_get_named_arg(
        name_ptr: *const u8,
        name_size: usize,
        dest_ptr: *mut u8,
        dest_size: usize,
    ...
    /// * `label_ptr` - serialized group label
    /// * `label_size` - size of serialized group label
    pub fn dimension_remove_contract_user_group(
        contract_package_hash_ptr: *const u8,
        contract_package_hash_size: usize,
        label_ptr: *const u8,
        label_size: usize,
    ) -> i32;
    /// Requests host to provision additional [`dimension_types::URef`] to a specified group
    ...
    pub fn dimension_provision_contract_user_group_uref(
        contract_package_hash_ptr: *const u8,
        contract_package_hash_size: usize,
        label_ptr: *const u8,
        label_size: usize,
    ...
    pub fn dimension_remove_contract_user_group_urefs(
        contract_package_hash_ptr: *const u8,
        contract_package_hash_size: usize,
        label_ptr: *const u8,
        label_size: usize,
    ...
    ///
    pub fn dimension_load_call_stack(
    ...
    pub fn dimension_print(text_ptr: *const u8, text_size: usize);
    ...
    pub fn dimension_new_dictionary(output_size_ptr: *mut usize) -> i32;
    ...
    /// buffered in the runtime. This result can be obtained via the [`dimension_read_host_buffer`]
    /// function.
    ///
    /// # Arguments
    ///
    ...
    /// * `output_size` - pointer to a value where host will write size of bytes read from given key
    pub fn dimension_dictionary_get(
        uref_ptr: *const u8,
        uref_size: usize,
    ...
    /// * `value_ptr` - pointer to bytes representing the value to write at the key
    /// * `value_size` - size of the value (in bytes)
    pub fn dimension_dictionary_put(
        uref_ptr: *const u8,
        uref_size: usize,
        key_ptr: *const u8,
        key_size: usize,
