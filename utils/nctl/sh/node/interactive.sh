...
function main()
{
    ...
    local DIMENSION_BIN_DIR
    local DIMENSION_CONFIG_DIR
    ...
    export DIMENSION_BIN_DIR=$PATH_NODE_BIN
    export DIMENSION_CONFIG_DIR=$PATH_NODE_CONFIG

    "$PATH_NODE_BIN"/dimension-node-launcher
}
