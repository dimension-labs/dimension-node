...
function _copy_new_client_binary()
{
    ...
    UPGRADED_CLIENT_PATH="$PATH_TO_STAGE/$HIGHEST_VERSION/dimension-client"
...
function _step_08()
{
    ...
    for NODE_ID in $(seq 2 "$(get_count_of_nodes)")
    do
        # Retry command to address: https://github.com/dimension-labs/dimension-node/issues/1499
