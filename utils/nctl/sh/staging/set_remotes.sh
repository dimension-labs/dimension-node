...
# Base URL: dimension-node-launcher.
_LAUNCHER_URL=http://nctl.dimensionlabs.io.s3-website.us-east-2.amazonaws.com/dimension-node-launcher/dimension-node-launcher
...
function _main()
{
    ...
    chmod +x ./dimension-node-launcher
    popd
