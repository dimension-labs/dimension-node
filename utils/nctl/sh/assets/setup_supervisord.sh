...
[program:dimension-net-$NET_ID-node-$NODE_ID]
autostart=false
autorestart=false
command=$PATH_NODE_BIN/dimension-node-launcher
environment=DIMENSION_BIN_DIR="$PATH_NODE_BIN",DIMENSION_CONFIG_DIR="$PATH_NODE_CONFIG"
numprocs=1
numprocs_start=0
startsecs=0
stopwaitsecs=0
