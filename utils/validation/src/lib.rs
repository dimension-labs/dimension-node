//! This crate contains types that contain the logic necessary to validate Dimension implementation
//! correctness using external test fixtures.
//!
//! Dimension test fixtures can contain multiple directories at the root level, which corresponds to a
