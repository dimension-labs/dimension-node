...
get_help() {
  ...
  echo -e "Example: $0 --repo-name debian --package-name [dimension-node|dimension-client]\n"
...
export BINTRAY_USER='dimensionlabs-service'
export BINTRAY_ORG_NAME='dimensionlabs'
...
if [ "$BINTRAY_REPO_NAME" == "dimension-debian-tests" ]; then
