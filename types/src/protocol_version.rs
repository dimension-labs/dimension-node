...
/// A newtype wrapping a [`SemVer`] which represents a Dimension Platform protocol version.
...
impl JsonSchema for ProtocolVersion {
    ...
    fn json_schema(gen: &mut schemars::gen::SchemaGenerator) -> schemars::schema::Schema {
        ...
        schema_object.metadata().description = Some("Dimension Platform protocol version".to_string());
        schema_object.into()
    }
}
