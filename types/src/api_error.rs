...
/// `ext_ffi::dimension_revert()` function.  This means the information each variant can convey is
/// limited.
///
...
/// `dimension_contract::runtime::revert()`, e.g.
/// ```
...
pub enum ApiError {
    ...
    /// ```
    Deserialize,
    /// `dimension_contract::storage::read()` returned an error.
    /// ```
    /// # use dimension_types::ApiError;
    ...
    /// ```
    ContractNotFound,
    /// A call to `dimension_contract::runtime::get_key()` returned a failure.
    /// ```
    /// # use dimension_types::ApiError;
    ...
    /// [dimension_types::system::auction::Error](crate::system::auction::Error).
    /// ```
    /// # use dimension_types::ApiError;
    ...
    /// ```
    AuctionError(u8),
    /// Contract header errors. See [dimension_types::contracts::Error](crate::contracts::Error).
    ///
    /// ```
    /// # use dimension_types::ApiError;
    ...
    /// [dimension_types::system::mint::Error](crate::system::mint::Error).
    /// ```
    /// # use dimension_types::ApiError;
    ...
    /// [dimension_types::system::handle_payment](crate::system::handle_payment::Error).
    /// ```
    /// # use dimension_types::ApiError;
