...
impl From<&Op> for dimension_types::OpKind {
    fn from(op: &Op) -> Self {
        match op {
            Op::Read => dimension_types::OpKind::Read,
            Op::Write => dimension_types::OpKind::Write,
            Op::Add => dimension_types::OpKind::Add,
            Op::NoOp => dimension_types::OpKind::NoOp,
        }
    }
}
