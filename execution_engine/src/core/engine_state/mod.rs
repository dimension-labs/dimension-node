    ...
    S::Error: Into<execution::Error>,
{
    ...
    pub fn commit_upgrade(
        ...
        // per specification:
        // https://dimensionlabs.atlassian.net/wiki/spaces/EN/pages/139854367/Upgrading+System+Contracts+Specification
    ...
    pub fn deploy(
        ...
        // spec: https://dimensionlabs.atlassian.net/wiki/spaces/EN/pages/123404576/Payment+code+execution+specification
