...
//!
//! This crate contain the core application for the Dimension blockchain. Run with `--help` to see
...
#![doc(html_root_url = "https://docs.rs/dimension-node/1.0.0")]
#![doc(
...
fn version_string(color: bool) -> String {
    let mut version = format!(
        ...
        if cfg!(feature = "dimentsion-mainnet") {
            "-dimentsion-mainnet"
        } else {
            ""
        }
