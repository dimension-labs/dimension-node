...
use dimension_types::{ProtocolVersion, PublicKey, SecretKey, Signature};
...
const CONFIG_ROOT_DIR: &str = "/etc/dimension";
/// Environment variable to override the config root dir.
const CONFIG_ROOT_DIR_OVERRIDE: &str = "DIMENSION_CONFIG_DIR";
