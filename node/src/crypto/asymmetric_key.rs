...
use dimension_types::{PublicKey, SecretKey, Signature};
...
mod tests {
    ...
    use dimension_types::{bytesrepr, checksummed_hex, AsymmetricType, Tagged};
    ...
    mod ed25519 {
        ...
        use dimension_types::ED25519_TAG;
...
-----END PUBLIC KEY-----"#;
    ...
    mod secp256k1 {
        ...
        use dimension_types::SECP256K1_TAG;
...
-----END PUBLIC KEY-----"#;
        ...
        fn validate_known_signature() {
            // In the event that this test fails, we need to consider pinning the version of the
            // `k256` crate to maintain backwards compatibility with existing data on the Dimension
            // network.
