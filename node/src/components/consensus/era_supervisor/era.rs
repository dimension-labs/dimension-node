...
use dimension_types::{PublicKey, U512};
...
const DIMENSION_ENABLE_DETAILED_CONSENSUS_METRICS_ENV_VAR: &str =
    "DIMENSION_ENABLE_DETAILED_CONSENSUS_METRICS";
static DIMENSION_ENABLE_DETAILED_CONSENSUS_METRICS: Lazy<bool> =
    Lazy::new(|| env::var(DIMENSION_ENABLE_DETAILED_CONSENSUS_METRICS_ENV_VAR).is_ok());
    ...
    fn estimate_heap_size(&self) -> usize {
        ...
        let consensus_heap_size = {
            ...
            if let Some(highway) = any_ref.downcast_ref::<HighwayProtocol<I, ClContext>>() {
                if *DIMENSION_ENABLE_DETAILED_CONSENSUS_METRICS {
