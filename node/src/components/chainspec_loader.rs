...
//!
//! See
//! <https://dimensionlabs.atlassian.net/wiki/spaces/EN/pages/135528449/Genesis+Process+Specification>
//! for full details.
...
use dimension_types::{bytesrepr::FromBytes, EraId, ProtocolVersion, StoredValue};
