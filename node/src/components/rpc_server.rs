...
//! <https://github.com/DimensionLabs/ceps/blob/master/text/0009-client-api.md#rpcs>
...
use dimension_execution_engine::core::engine_state::{
    self, BalanceRequest, BalanceResult, GetBidsRequest, GetEraValidatorsError, QueryRequest,
    QueryResult,
};
use dimension_hashing::Digest;
use dimension_types::{system::auction::EraValidators, Key, ProtocolVersion, URef};
...
mod tests {
    ...
    #[test]
    fn schema() {
        // The expected schema depends on the hashing algorithm selected by the `dimentsion-mainnet`
        // feature.
        //
        ...
        // ```
        // cargo t --features=dimentsion-mainnet components::rpc_server::tests::schema -- --nocapture
        ...
        #[cfg(feature = "dimentsion-mainnet")]
        let schema_path = format!(
            "{}/../resources/test/rpc_schema_hashing_V1.json",
            env!("CARGO_MANIFEST_DIR")
        );

        // #[cfg(not(feature = "dimentsion-mainnet"))]
        // let schema_path = format!(
