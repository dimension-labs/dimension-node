...
//!
//! See <https://github.com/DimensionLabs/ceps/blob/master/text/0009-client-api.md#rpcs> for info.
...
mod common {
    ...
    use dimension_execution_engine::core::engine_state::{self, QueryResult};
    use dimension_types::bytesrepr::ToBytes;
