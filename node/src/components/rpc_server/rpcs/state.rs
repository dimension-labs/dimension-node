...
use dimension_execution_engine::core::engine_state::{BalanceResult, GetBidsResult, QueryResult};
...
pub struct GetItemParams {
    ...
    /// `dimension_types::Key` as formatted string.
    pub key: String,
...
impl RpcWithParamsExt for GetItem {
    fn handle_request<REv: ReactorEventT>(
        ...
        async move {
            // Try to parse a `dimension_types::Key` from the params.
