...
use dimension_execution_engine::shared::execution_journal::ExecutionJournal;
use dimension_types::{EraId, ExecutionEffect, ExecutionResult, PublicKey, U512};
    ...
    REv: From<ContractRuntimeAnnouncement>,
{
    effect_builder
        .schedule_regular(ContractRuntimeAnnouncement::StepSuccess {
            era_id,
            execution_effect: dimension_types::ExecutionEffect::from(&execution_journal),
        })
        .await
}
