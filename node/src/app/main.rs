...
//!
//! This is the core application for the Dimension blockchain. Run with `--help` to see available
...
use dimension_node::{cli::Cli, MAX_THREAD_COUNT};
...
fn main() -> anyhow::Result<()> {
    ...
    info!(%exit_code, "exiting dimension-node");
