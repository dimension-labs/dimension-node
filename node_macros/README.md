...
[![Crates.io](https://img.shields.io/crates/v/dimension-node-macros)](https://crates.io/crates/dimension-node-macros)
[![Documentation](https://docs.rs/dimension-node-macros/badge.svg)](https://docs.rs/dimension-node-macros)
...
The `dimension-node-macros` crate offers an easy-to-use macro to create reactor implementations for the component system. It enforces a set of convention and allows generating a large amount of otherwise boilerplate heavy setup code comfortably.
